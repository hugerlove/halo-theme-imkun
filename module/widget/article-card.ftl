                ...
                <div class="im-weight-3-content-article">
                    ...
                    <div class="im-weight-3-footer">
                        ...
                        <div class="im-weight-3-footer-comments gray weight-extra-font-size"><span
                                    style="padding-right:20px"><i class="fa fa-eye"
                                                                  style="padding-right: 5px;"></i>${post.visits}</span><span><i
                                        class="fa fa-comment" style="padding-right: 5px;"></i>${post.visits}</span>
                        </div>
                    </div>
                </div>
            </div>
