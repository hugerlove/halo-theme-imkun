<#macro default title,keyword,desc,canonical,body_class>
    ...
    <head>
        ...
        <meta name="twitter:image"
              content="${options.casper_general_cover!'/${static!}/assets/images/blog-cover.jpg'}"/>
        <meta name="twitter:site" content="@tryghost"/>
        <meta property="og:image:width" content="2000"/>
        <meta property="og:image:height" content="666"/>
        <meta name="generator" content="Halo 0.0.7"/>
        <link rel="alternate" type="application/rss+xml" title="${options.blog_title}"
              href="${options.blog_url}/feed.xml"/>
        ...
        <#if post??>
            ...
            <link rel="stylesheet" type="text/css"
                  href="${static!}/assets/prism/css/prism-${settings.code_pretty!'dracula'}.css"/>
